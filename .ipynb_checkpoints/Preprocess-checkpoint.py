...
df_comb.to_csv("disease_symptom_dataset_combination1.csv",index=None)
df_norm.to_csv("dis_sym_dataset_normal1.csv",index=None)
...
with open('disease_symptom_dictionary1.txt', 'w') as f:
